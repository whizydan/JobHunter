...
<div class="page-btn">
<a href="addstaff.jsp" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img">Add Staff</a>
</div>
</div>
...
<c:forEach var="staff" items="${staff}">
                        <tr>
                            ...
                            <td>${staff.gender}</td>
                            <td>
                                <a class="me-3" href="EditStaff?id=${staff.id}">
                                    <img src="assets/img/icons/edit.svg" alt="img">
                                </a>
                                <a class="me-3" href="DeleteUser?id=${staff.id}">
